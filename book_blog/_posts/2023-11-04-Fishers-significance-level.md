...
According to the law of large numbers, one has to repeat the flip many times in order to achieve the expected 1:1 ratio of heads to tails.
How many times?
The consensual number, twenty, was theorized by the statistician an geneticist Ronald Fisher.
According to Fisher's significance level, nineteen tails in a row may still be due to chance, but twenty signifies a loaded coin.
In experimental science, results obtained twenty times are said to be signfiicant, refuting the null hypothesis.

**Something is wrong here with the math, isn't it?**
